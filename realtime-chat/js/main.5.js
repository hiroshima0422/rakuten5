...
function createMessageDiv(messageId, message) {
   ...
   * お気に入りボタンがクリック
   */
   //console.dir(currentUID);
   //console.dir(messageId);
   //console.dir(message.uid);
   if (dbdata.favorites !== null) {
  ...
  $div.find(".glyphicon-star-empty").on("click",function(){
      ...
      // 
        //if ($div.find(".glyphicon-star-empty")) {
          var message_data = {
            uid: messageId,
            text: message,
          ...
          firebase.database().ref("favorites/" + currentUID + "/" + message.uid).set({
            ...
            $div.find(".glyphicon").removeClass("glyphicon-star-empty");
            $div.find(".glyphicon").addClass("glyphicon-star");
  });       
  $div.find(".glyphicon-star").on("click",function(){        
        ...
        //if ($div.find(".glyphicon-star-empty")) {
          ...
          $div.find(".glyphicon").removeClass("glyphicon-star");
          $div.find(".glyphicon").addClass("glyphicon-star-empty");
